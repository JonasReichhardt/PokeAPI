        ...
        fetch(link).then(function (response) {
            response.json().then(function (pokelist) {
                ...
                for (var _i = 0, _a = pokelist.results; _i < _a.length; _i++) {
                    var pokemon = _a[_i];
                    html += "<tr><td>" + pokemon.name.toUpperCase() + "</td><td><button data-activates=\"slide-out\"\" class=\"waves-effect waves-light btn\"\" onclick=details('" + pokemon.url + "')>Details</button></td></tr>";
                }
